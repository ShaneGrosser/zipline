...
DEFAULT_PER_SHARE_COST = 0              # 0 cents per share
DEFAULT_PER_CONTRACT_COST = 0             # $0 per future contract
DEFAULT_PER_DOLLAR_COST = 0             # 0 cents per dollar
DEFAULT_MINIMUM_COST_PER_EQUITY_TRADE = 0  # $0 per trade
DEFAULT_MINIMUM_COST_PER_FUTURE_TRADE = 0  # $0  per trade
